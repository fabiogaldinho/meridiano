...
function SkeletonArticlePage() {
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      {/* Hero image skeleton */}
      <div className="relative rounded-2xl dark:bg-slate-700 overflow-hidden shadow-2xl mb-8 h-[400px] bg-gray-200 animate-pulse" />

      {/* Summary section skeleton */}
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-8 mb-8">
        <div className="h-6 bg-gray-200 dark:bg-slate-700 rounded w-48 mb-4 animate-pulse" />
