...
function SkeletonFeedPage() {
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="h-12 bg-gray-200 dark:bg-slate-700 rounded w-64 mb-8 animate-pulse" />

      {/* Carousel skeleton */}
      <SkeletonCarousel />

      {/* Título "Principais Notícias" skeleton */}
      <div className="h-9 bg-gray-200 dark:bg-slate-700 rounded w-72 mb-6 animate-pulse" />
      ...
      <div className="flex justify-center items-center gap-2 mt-12">
        ...
        <div className="h-10 w-10 bg-gray-200 dark:bg-slate-700 rounded animate-pulse"></div>
        <div className="h-10 w-10 bg-gray-200 dark:bg-slate-700 rounded animate-pulse"></div>
        <div className="h-10 w-10 bg-gray-200 dark:bg-slate-700 rounded animate-pulse"></div>
        <div className="h-10 w-24 bg-gray-200 dark:bg-slate-700 rounded animate-pulse"></div>
      </div>
